...
class CalculateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $holdingCosts = $this->getHoldingCosts($report);
        $mortage = $this->getMortgagePayment($report);

        return view("results")->compact('report', 'purchaseValues', 'mortgage', 'holdingCosts');
    }
    ...
    public function getMortgagePayment($report)
    {
        // M = P[r(1+r)^n/((1+r)^n)-1)]
            /*
    ...
    public function getHoldingCosts($report)
    {
